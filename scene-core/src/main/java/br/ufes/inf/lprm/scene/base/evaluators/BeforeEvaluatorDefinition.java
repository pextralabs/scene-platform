    ...
    public static class BeforeEvaluator extends BaseEvaluator {
        ...
        public boolean evaluateCachedRight(InternalWorkingMemory workingMemory,
            ...
            if ( this.unwrapRight ) {
            	...
            	{        		
            		if ( ! ((SituationType) rightFact).isActive() ) {
            			rightTS = ((SituationType) rightFact).getDeactivation().getTimestamp();
            		}
            		else {
            			return false;
            		}           		
            ...
            if (this.unwrapLeft) {
            	...
            	Object leftFact = workingMemory.getObject((FactHandle) left);
            	
	        	if(leftFact instanceof SituationType )
	        	{
            		leftTS = ((SituationType) leftFact).getActivation().getTimestamp();
        ...
        public boolean evaluate(InternalWorkingMemory workingMemory,
            ...
            if (this.unwrapRight) {
           		rightTS = extractor1.getLongValue( workingMemory, object1 );         	
           }
           else {           	
        	   Object rightFact = workingMemory.getObject((FactHandle) object1);
        	   ...
        	   if(rightFact instanceof SituationType ) {
        		   ...
        		   rightTS = ((EventFactHandle) object1).getEndTimestamp();
        	   }         
           	}              
            ...
            if (this.unwrapLeft) {
			  	leftTS = extractor2.getLongValue( workingMemory, object2 );         	
			  }
			  else {
			  	
			  	Object leftFact = workingMemory.getObject((FactHandle) object2);
			  	
				if(leftFact instanceof SituationType ) {
					leftTS = ((SituationType) leftFact).getActivation().getTimestamp();
				} else {
					leftTS = ((EventFactHandle) object2).getStartTimestamp();
				}            
			  }            
